...
comscore_total AS (
    SELECT 
    'General Population' as groupName,
...
SELECT * FROM comscore_total
UNION ALL
SELECT * FROM pet_interest
UNION ALL
SELECT * FROM pet_intenders
UNION ALL
SELECT * FROM pet_converters
...
CROSS JOIN total_audience
        ...
        WHEN (domain LIKE '%baileyblu.com%'  OR event_detail LIKE '%baileyblu.com%')            THEN 'Retail E-Commerce'
        WHEN (domain LIKE '%chico.ca%' OR event_detail LIKE '%chico.ca%')                       THEN 'Retail E-Commerce'
        WHEN (domain LIKE '%mondou.com%' OR event_detail LIKE '%mondou.com%')                   THEN 'Retail E-Commerce'
        WHEN (domain LIKE '%pattesgriffes.com%' OR event_detail LIKE '%pattesgriffes.com%')     THEN 'Retail E-Commerce'
        WHEN (domain LIKE '%tailblazerspets.com%' OR event_detail LIKE '%tailblazerspets.com%') THEN 'Retail E-Commerce'
        WHEN (domain LIKE '%wbu.com%' OR event_detail LIKE '%wbu.com%')                         THEN 'Retail E-Commerce'
