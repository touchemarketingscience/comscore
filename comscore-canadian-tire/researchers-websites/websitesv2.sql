WITH user_data_comscore AS (
    ...
    WHEN domain = 'google.com' THEN 'Search Engine / Technology'
    WHEN domain = 'youtube.com' THEN 'Video Streaming'
    WHEN domain = 'facebook.com' THEN 'Social Media'
    WHEN domain = 'google.ca' THEN 'Search Engine / Technology'
    WHEN domain = 'bing.com' THEN 'Search Engine'
    WHEN domain = 'live.com' THEN 'Web Portal / Email'
    WHEN domain = 'microsoft.com' THEN 'Web Portal / Email'
    WHEN domain = 'amazon.ca' THEN 'E-commerce & Shopping'
    WHEN domain = 'yahoo.com' THEN 'Web Portal / Email'
    WHEN domain = 'msn.com' THEN 'Web Portal'
    WHEN domain = 'wikipedia.org' THEN 'Reference'
    WHEN domain = 'canada.ca' THEN 'Government'
    WHEN domain = 'amazon.com' THEN 'E-commerce & Shopping'
    WHEN domain = 'instagram.com' THEN 'Social Media'
    WHEN domain = 'gc.ca' THEN 'Government'
    WHEN domain = 'tiktok.com' THEN 'Social Media'
    WHEN domain = 'linkedin.com' THEN 'Social Media'
    WHEN domain = 'twitter.com' THEN 'Social Media'
    WHEN domain = 'pinterest.ca' THEN 'Social Media'
    WHEN domain = 'reddit.com' THEN 'Social Media'
    WHEN domain = 'unpkg.com' THEN 'Technology / CDN'
    WHEN domain = 'walmart.ca' THEN 'E-commerce & Shopping'
    ...
    WHEN domain = 'canadiantire.ca' THEN 'E-commerce & Shopping'
    ...
    WHEN domain = 'pinterest.com' THEN 'Social Media'
    ...
    WHEN domain = 'wayfair.ca' THEN 'E-Commerce & Shopping'
    ...
    WHEN domain = 'aliexpress.com' THEN 'E-Commerce & Shopping'
    ...
    WHEN domain = 'walmart.com' THEN 'E-commerce & Shopping'
...
total_audience AS (
    SELECT COUNT(DISTINCT guid) AS total_users_audience
    FROM user_data_comscore WHERE
    domain_category = 'PETS'
)

SELECT
    a.domain_subcategory,
    a.unique_users as unique_users_comscore,
    b.unique_users as unique_users_pets
FROM audience_comscore AS a LEFT JOIN audience_pets AS b 
ON a.domain_subcategory = b.domain_subcategory
