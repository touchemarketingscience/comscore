WITH user_data_comscore AS (
    ...
    WHERE date_part(year, calendar_date) = 2019 OR date_part(year, calendar_date) = 2020 OR date_part(year, calendar_date) = 2021 OR date_part(year, calendar_date) = 2022
),
