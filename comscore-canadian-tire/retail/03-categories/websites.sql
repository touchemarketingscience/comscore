...
( -- INTENDER LOGIC NEGATION
            (domain LIKE '%canadiantire.c%')
        OR (domain LIKE '%amazon.c%')
        OR (domain LIKE '%walmart.c%')
        OR (domain LIKE '%bestbuy.c%')
        OR (domain LIKE '%wayfair.c%')
        OR (domain LIKE '%ikea.c%' )
        OR (domain LIKE '%homesense.c%')
        OR (domain LIKE '%winners.c%')
        OR (domain LIKE '%thebay.c%')
        OR (domain LIKE '%labaie.c%')
        OR (domain LIKE '%marshalls.c%')
        OR (domain LIKE '%homehardware.c%')
        OR (domain LIKE '%homedepot.c%')
        OR (domain LIKE '%rona.c%')
        OR (domain LIKE '%lowes.c%')
        OR (domain LIKE '%renodepot.c%')
        OR (domain LIKE '%costco.c%')
        OR (domain LIKE '%dollarama.c%')
   )
ORDER BY 2 DESC
LIMIT 100000;