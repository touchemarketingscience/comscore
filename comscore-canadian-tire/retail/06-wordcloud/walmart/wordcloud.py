...
#     if '/browse/' in path:
#         # Only consider parts after '/browse/'
#         path = path.split('/browse/', 1)[1]
...
# 4. Generating the word cloud
word_cloud = WordCloud(background_color='white', colormap='winter', width = 1597, height = 610).generate_from_frequencies(word_counts)
